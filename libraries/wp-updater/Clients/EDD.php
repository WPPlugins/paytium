<?php
namespace Paytium\WP_Updater\Clients;

use Paytium\WP_Updater\Plugin;
...
class EDD implements ClientInterface {
	...
	public function activate() {
		...
		switch ( $body->error ) {
			...
			case 'expired' :
				$message = __( 'Your license key has expired, please renew it through our system', 'paytium' );
				$code = 'expired';
				break;
			case 'revoked' :
				$message = __( 'Your license has been revoked', 'paytium' );
				break;
			case 'missing' :
				$message = __( 'Invalid license key, please verify your license and try again', 'paytium' );
				break;
			case 'site_inactive' :
			case 'invalid' :
				$message = __( 'Your license is not active for this URL', 'paytium' );
				break;
			case 'item_name_mismatch' :
				$message = sprintf( __( 'This license is not valid for %s', 'paytium' ), $this->plugin->get_name() );
				break;
			case 'no_activations_left' :
				$message = __( 'Your license has reached its activation limit', 'paytium' );
				break;
			default :
				$message = __( 'Something went wrong, please verify everything and try again', 'paytium' );
				break;
		}
