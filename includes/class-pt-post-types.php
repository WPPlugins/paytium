...
class PT_Post_Types {
	...
	public function register_post_type() {
		...
		$labels = array (
			...
			'not_found'          => __( 'No Payments found.', 'paytium' ),
		...
		$args = array (
			'labels'              => $labels,
			'public'              => false,
            // TODO: Actually want to set public to true for export plugins, but that also adds Yoast SEO stuff...
	...
	public function payments_overview_details_for_payments( $payment ) {
		...
		} elseif ( $payment->subscription == 1 && $payment->subscription_payment_status == 'completed' ) {
