...
function pt_register_settings() {
	...
	// TODO David
	// Should this include settings?
	// function pt_register_settings($settings) {
	...
	$pt_settings = array (
		...
		'default' => array (
			array (
				...
				'name' => '',
				'desc' => sprintf( '<a href="%s" target="_blank">%s</a>', pt_ga_campaign_url( PT_WEBSITE_BASE_URL . 'handleiding', 'paytium', 'settings', 'docs' ), __( 'See shortcode options and examples', 'paytium' ) ) . ' ' .
			...
			// TODO David - Re-enable and re-develop bulling and shipping fields
			//			'billing' => array(
			//				'id'   => 'paytium_billing',
			//				'name' => __( 'Enable Billing Address', 'paytium' ),
			//				'desc' => __( 'Require the user to enter their billing address during checkout.', 'paytium' ) .
			//						( class_exists( 'Paytium' ) ? '<br/><p class="description">' . __( 'See below if you also need to require a shipping address.', 'paytium' ) . '</p>' : '' ),
			//				'type' => 'checkbox'
			//			),
			//			'shipping' => array(
			//				'id'   => 'paytium_shipping',
			//				'name' => __( 'Enable Shipping Address', 'paytium' ),
			//				'desc' => __( 'Require the user to enter their shipping address during checkout.', 'paytium' ) . '<br/>' .
			//				          '<p class="description">' . __( 'When a shipping address is required, the customer is also required to enter a billing address.', 'paytium' ) . '</p>',
			//				'type' => 'checkbox'
			//			),
			array (
		...
		'keys'    => array (
			...
			array (
				...
				'name' => '',
				'desc' => sprintf( '<a href="%s" target="_blank">%s</a>', 'https://www.mollie.com/nl/signup/335035', __( 'Login at Mollie to find your API keys', 'paytium' ) ),
				'type' => 'section'
			),
			array (
