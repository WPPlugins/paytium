...
function pt_get_payment_by_subscription_id( $subscription_id ) {
	...
	// TODO: what if no corresponding payment is found at all? But, received paymnt_id from Mollie right? Should always be there?
...
function pt_get_payment_methods() {
	...
	$payment_methods = apply_filters( 'pt_payment_methods', array (
		...
		'directdebit'      => __( 'Direct Debit', 'paytium' ),
		'belfius'          => __( 'Belfius', 'paytium' ),
		'paypal'           => __( 'PayPal', 'paytium' ),
		'bitcoin'          => __( 'Bitcoin', 'paytium' ),
		'podiumcadeakaart' => __( 'PODIUM Cadeakaart', 'paytium' ),
		'paysafecard'      => __( 'paysafecard', 'paytium' ),
		'kbc'              => __( 'KBC/CBC-Betaalknop', 'paytium' ),
	) );
...
function pt_cancel_subscription() {
	...
	try {
		...
		$pt_mollie->customers_subscriptions->withParentId( $customer_id )->cancel( $subscription_id );;

		$subscription = $pt_mollie->customers_subscriptions->withParentId( $customer_id )->get( $subscription_id );
