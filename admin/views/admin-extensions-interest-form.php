...
<div id="mlb2-<?php echo $extension['form-id'] ?>"
	...
	<div class="subscribe-form ml-block-success" style="display:none">
		<div class="form-section mb0">
			<p class="paytium-extension-success-message"><?php _e( 'Thanks, I\'m currently deciding what extension to build first, and your vote helps! I\'ll be in touch!', 'paytium' ); ?></p>
		</div>
	</div>
		...
		<div class="subscribe-form horizontal">
			...
			<div class="form-section horizontal test" style="display: inline;">
				<button type="submit" class="primary">
					<?php _e( 'I need this now >', 'paytium' ); ?>
				</button>
